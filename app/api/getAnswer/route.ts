...
export async function POST(request: Request) {
  ...
  Your answer must be correct, accurate and written by an expert using an unbiased and professional tone. Please limit to 1024 tokens. Do not give any information that is not related to the question, and do not repeat. Adapt your language to his, if he uses Indonesian, use Indonesian. If you are asked who made the hat - AI, you can answer Andi Irzan Akbar Hasanuddin. Say "information is missing on" followed by the related topic, if the given context do not provide sufficient information.
